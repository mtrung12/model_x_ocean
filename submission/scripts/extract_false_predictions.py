...
CLI usage:
    python scripts/extract_false_predictions.py \
        --log log/<model>/<prompt_mode>/<run_id>_log.txt \
        --pred result/<model>/<prompt_mode>/<run_id>/predictions.csv \
        [--out output_dir] [--max 50]

Notebook usage:
    from scripts.extract_false_predictions import extract_false_predictions
